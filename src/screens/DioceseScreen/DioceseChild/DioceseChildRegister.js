...
export default () => {
   ...
   const handleRegisterButton = async () => {
      ...
      try {
         ...
         let databaseRef = database().ref(`/bd/paroquia/${token}`);

         if (avatar) {
            let storageRef = storage().ref(`images/paroquia/${token}`);
         ...
         resetField();
         navigation.navigate('DioceseChild');
      ...
      <SafeAreaView style={styles.container}>
         ...
         <View style={styles.headerArea}>
            <View style={styles.welcomeArea}>
               <Text style={styles.welcomeText}>Paróquia</Text>
            </View>
